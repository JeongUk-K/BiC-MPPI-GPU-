// Manipulator MPPI — uses the generic cuda-accel MPPI_GPU solver
// Manipulator-specific cost / collision are defined in manipulator_model.h
...
int main() {
  ...
  std::cout << "[Manipulator MPPI] Initialized solver successfully.\n";
