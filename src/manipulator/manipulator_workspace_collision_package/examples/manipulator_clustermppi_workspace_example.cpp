...
int main() {
  ...
  // ---------------------------------------------------------------------------
  const std::string solver_label = "Cluster-MPPI";
  const std::string csv_prefix = "manipulator_workspace_clustermppi_";
  const std::uint_fast64_t seed = 260625ULL;
  ...
  const double cluster_epsilon = 3.8;
