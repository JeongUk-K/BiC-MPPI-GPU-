...
int main() {
  ...
  // ---------------------------------------------------------------------------
  const std::string solver_label = "Log-MPPI";
  const std::string csv_prefix = "manipulator_workspace_logmppi_";
  const std::uint_fast64_t seed = 260624ULL;
